...
console.log(tyrannosaurus.epoch);
...
*/
const animalNames = zooAnimals.forEach( obj => {
  console.log(`Name: ${obj.animal_name}, Scientific: ${obj.scientific_name}`);
});;
...
*/
const populationTotal = zooAnimals.reduce((accumulator, obj) => {
